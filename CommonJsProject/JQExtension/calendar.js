(function (window, jQuery) {
    ...
    function Calendar(ele, options) {
        ...
        this.date = new Date();
        this.curr_time_arr = [date.getFullYear(), date.getMonth(), date.getDate(), date.getHours(), date.getMinutes(), date.getSeconds()];  //文本框中的日期
    ...
    Calendar.prototype = {
        ...
        init: function () {
            this.defaults.dateString = ele.attr('dateval'); //从后文本框取出date的值
